...
$last_version = file_get_contents("http://www.dabach.net/easyschool/version.txt", true);


if ($last_version == true) {

    if ($current_version !== $last_version) {
    echo "<div class='alert alert-warning' style='margin: auto;'><button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
      <h3>New version of EasySchool !</h3>
      <p>new version is valable, check it from <a href='http://www.dabach.net/easyschool/'>HERE</a></p>
      </div>";
    }
}
...
<h2 class="edit"><?php echo $lang ['ask_more_option']; ?> :</h2>

<div class='alert alert-info'>
<h3 style='line-height: 32px'><?php echo $lang ['ask_more_option_p']; ?> <a href="http://www.dabach.net"><span class='label label-success'>www.dabach.net</span></a></h3>    
</div>
<br>
