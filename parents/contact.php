...
$fff = "111";
   ...
   $stmt_messages = $connect->prepare("INSERT INTO users_messages (author_index, author_name, to_index, type, subject, message, date) VALUES ('$parent_index', :author_name, :to_index, '$message_from', :subject, :message, '$message_date')");
 ...
 ?>
  ...
  <form id="formID" method="post" action="">
              ...
              <div class="input-group">
                  ...
                  <option selected="selected" value="parent"><?php echo $lang ['guardian']; ?></option>
                  </select>
              </div><br>
