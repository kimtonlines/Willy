...
<div class="row">
    ...
    <div class="col-md-3">
      <a href="students.php">
          <div class="link">
            ...
            <div class="clear"></div><span><?php echo $lang ['My_children']; ?></span>
         </div>
      </a>
    </div>
    ...
    <div class="col-md-3">
      <a href="exams.php">
          <div class="link">
            <img src="../images/icons/1305214346_preferences-system-time.png" width="80px">
...
<?php 
  ...
  $stmt_messages = $connect->query("SELECT * FROM users_messages WHERE to_index='$parent_index' AND msg_read='0'");
...
?>
	...
	<?php 
$stmt_to_index = $connect->query("SELECT * FROM index_users WHERE full_name='administrator' ");
$row_indexs = $stmt_to_index->fetch();
$index_num = $row_indexs ['index_num'];

     ?>

    <div class="col-md-3">
      <a href="contact.php?id=<?php echo $index_num;?>">
          <div class="link">
            <img src="../images/icons/school.png" width="80px">
            <div class="clear"></div><span><?php echo $lang ['Contacter_Administration']; ?></span>
         </div>
      </a>
    </div>
