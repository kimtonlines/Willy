...
$stmt_get_allInfo = $connect->query("SELECT * FROM parents_users WHERE parent_index='$parent_index' ");
 ...
 <a class="return" href="index.php"><i class="glyphicon glyphicon-arrow-left"></i> <?php echo $lang ['return']; ?></a><br><br>
  ...
  <div class="panel panel-info">
    <div class="panel-heading center">
      ...
      <h2><?php echo $my_fullname; ?> <br> <span><?php echo $lang ['guardian']; ?></span></h2>
...
if (isset($_POST['update_info'])) {
  ...
  $update_email = htmlspecialchars($_POST['email']);
   ...
   $stmt_update_info = $connect->prepare("UPDATE parents_users SET email=:email, phone=:phone, address=:address WHERE parent_index='$parent_index'");
...
if (isset($_POST['update_passe'])) {
  ...
  $stmt_get = $connect->query("SELECT * FROM parents_users WHERE parent_index='$parent_index' ");
