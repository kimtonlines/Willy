...
<div class="clear"></div>
    ...
    <h1 class="h1_title"><?php echo $lang ['news']; ?></h1>
    <hr>
...
$count_sql = $connect->query ("SELECT * FROM topics");
...
if (($page > $pages_count) || ($page <= 0 )) {
  die('<br><br><br><div class="alert alert-info center" style="width: 90%; margin: auto"><p>'.$lang ['Nothing_found_404_articles'].'</p></div><br><br><br>') ;
}
...
if ($records_count != 0) {
      ...
      $stmt_topics = $connect->prepare("SELECT * FROM topics ORDER BY id DESC LIMIT $start, $end");
      $stmt_topics->execute();
       ...
       ?>
          <div class="single">
                ...
                <div class="single_header">
                  ...
                  <h2><a href="view_article.php?id=<?php echo $topic_id; ?>"><?php echo $topic_title; ?></a></h2>  
