...
if (!isset($_GET['id'])) {
        die('<div class="alert alert-danger center" style="width: 90%; margin: auto;"><p>'.$lang ['Nothing_found_404'].'</p> </div><br><br>');
    }
...
if (isset($_GET['id'])) {
  ...
  if ($stmt_topics->rowCount() != 1) {
        die('<div class="alert alert-danger center" style="width: 90%; margin: auto;"><p>'.$lang ['sorry_There_is_no_topic_with_this_link'].'</p>  </div><br><br>');
    }
...
if (isset($_POST['submit'])) {
  ...
  $author = $_SESSION ['student_index'];
   ...
   $stmt_comment = $connect->prepare("INSERT INTO comments (comment, type, author, article_id, comment_date) VALUES (:comment, 'student', '$author', :article_id, '$comment_date')");
