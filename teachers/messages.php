...
$records_at_page = 20;
$count_sql = $connect->query ("SELECT * FROM users_messages WHERE to_index='$teacher_index'");
...
$stmt_messages_read = $connect->query("UPDATE users_messages SET msg_read='1' WHERE to_index='$teacher_index'");

$stmt_messages = $connect->query("SELECT * FROM users_messages WHERE to_index='$teacher_index' ORDER BY id DESC LIMIT $start, $end");
